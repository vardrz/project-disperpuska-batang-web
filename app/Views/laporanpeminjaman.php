...
<div class="container">
    <div class="row">
        <div class="col-12">
            ...
            <h1 class="my-4">Tabel Laporan Peminjaman</h1>
            <div class="text-right mb-3">
                ...
                <a href="/home/laporan-peminjaman" class="btn btn-danger" id="reset-filter">Reset Filter</a>
            ...
            <div class="text-right my-3">
                <a href="/home/laporan-peminjaman/pdf/<?= $date_start . "|" . $date_finish ?>" class="btn btn-danger">PDF</a>
